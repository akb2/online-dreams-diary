...
import { Clock, Color, Euler, Float32BufferAttribute, Matrix4, MeshPhongMaterial, MeshStandardMaterial, NearestMipmapLinearFilter, PlaneGeometry, RepeatWrapping, Texture, Triangle, Vector3, sRGBEncoding } from "three";
