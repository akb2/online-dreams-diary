...
import { CustomObject, MultiObject, SimpleObject } from "@akb2/types-tools";
...
export const ApiResponseMessages: SimpleObject = {
  ...
  "4001": "Ошибка загрузки медиа файла на сервер",
  "4002": "Медиа файл не передан для загрузки",
  ...
  "7006": "У вас нет доступа для создания толкования данного сновидения",
  "7007": "Не удалось создать толкование для сновидения",
  ...
  "8103": "Пользователь запретил вам оставлять комментарии настройками приватности",
  "8104": "Пользователь запретил вам читать комментарии настройками приватности",
